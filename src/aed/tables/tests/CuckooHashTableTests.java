...
public class CuckooHashTableTests {
    ...
    public static void test12()
    {
        ...
        hashTable.put(8, pseudoRandom.nextInt(1500));
        hashTable.put(2, pseudoRandom.nextInt(1500));
        hashTable.put(9, pseudoRandom.nextInt(1500));
        ...
        System.out.println("Swap average: " + String.format(Locale.US,"%.02f",hashTable.getSwapAverage()));
        System.out.println("Swap variation, (0.25 or 0.33): " + (hashTable.getSwapVariation()==0.25f || hashTable.getSwapVariation()==0.33333334f));
        ...
        System.out.println("Swap average: " + String.format(Locale.US,"%.02f",hashTable.getSwapAverage()));
        System.out.println("Swap variation, 0.13 <= v <= 0.141: " + (0.13f<=hashTable.getSwapVariation()&& hashTable.getSwapVariation()<=0.141f));
    }
